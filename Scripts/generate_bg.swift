...
let colors = [
    NSColor(calibratedRed: 0.8, green: 0.9, blue: 1.0, alpha: 1.0).cgColor, // Soft Pastel Blue
    NSColor(calibratedRed: 0.9, green: 0.8, blue: 1.0, alpha: 1.0).cgColor  // Soft Pastel Purple
] as CFArray
...
let outURL = URL(fileURLWithPath: "/Users/xavierscott/Documents/Media Organizer/Scripts/dmg_background.png")
try pngData.write(to: outURL)
print("Successfully restored super cute pastel background!")
